...
class Taxi_Enqueue {
	...
	public function taxi_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'taxi_frontend_enqueue_scripts', ) );
	}

	public function taxi_frontend_enqueue_scripts( ) {
