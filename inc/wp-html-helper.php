...
// image default alt
if( ! function_exists( 'taxi_img_default_alt' ) ) {
	function taxi_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'taxi_img_tag' ) ) {
	function taxi_img_tag( array $args ) {
...
// Anchor Tag
if( ! function_exists( 'taxi_anchor_tag' ) ) {
	function taxi_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'taxi' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'taxi_heading_tag' ) ) {
	function taxi_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'taxi' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'taxi_paragraph_tag' ) ) {
	function taxi_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'taxi_other_tag' ) ) {
	function taxi_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'taxi_button_element ' ) ) {
	function taxi_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'taxi' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
