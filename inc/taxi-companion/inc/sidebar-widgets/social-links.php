...
class taxi_social_links_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        'taxi_social_links_widget',

        // Widget name will appear in UI
        esc_html__( '[ Taxi ] Social Links', 'taxi' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'taxi' ), )
        );
    ...
    public function form( $instance ) {
        ...
        isset( $instance[ 'title' ] ) ? $title = $instance[ 'title' ] : $title = esc_html__( 'Social Links', 'taxi' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'taxi'); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook:' ,'taxi'); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'facebook' ) ); ?>" type="text" value="<?php echo esc_attr( $facebook ); ?>" />
        </p>

        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter:' ,'taxi'); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'twitter' ) ); ?>" type="text" value="<?php echo esc_attr( $twitter ); ?>" />
        </p>

        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble:' ,'taxi'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Behance:' ,'taxi'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin:' ,'taxi'); ?></label>
...
} // Class taxi_social_links_widget ends here


// Register and load the widget
function taxi_social_links_load_widget() {
	register_widget( 'taxi_social_links_widget' );
}
add_action( 'widgets_init', 'taxi_social_links_load_widget' );