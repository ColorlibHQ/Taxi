<?php
/**
 * Class Name: taxi_bootstrap_navwalker
...
class taxi_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'.esc_html__( 'Add a menu', 'taxi' ).'</a></li>';
			$fb_output .= '</ul>';
...
class taxi_mobile_bootstrap_navwalker extends Walker_Nav_Menu {
...
// Social nav Walker
class taxi_social_navwalker extends Walker_Nav_Menu {
